...
<title>Departments | Administrator | Paper Jack Solutions</title>
<style type="text/css">
.content_head {
...
<div class="content">
<h1 class="content_head">Departments</h1>
<?php
include "connect.php";
...
if($result->num_rows > 0) {
 ...
 echo '<tr class="head_row"><td>Department ID</td><td>Department Name</td></tr>';
